...
export const CustomerLinksConfigSchema = z.object({
  // File paths
...
export type CustomerLinksConfig = z.infer<typeof CustomerLinksConfigSchema>;
export type CustomerSite = z.infer<typeof CustomerSiteSchema>;

export default CustomerLinksConfigSchema;